<template>
    <div>
        ...
        <div class="language-switcher" v-if="!isMobile">
            <button
                :class="['lang-btn', currentLang === 'ar' ? 'active-lang' : '']"
            ...
            <button
                :class="['lang-btn', currentLang === 'en' ? 'active-lang' : '']"
        ...
        >
            ...
            <div class="drawer-content">
                ...
                <div class="drawer-bottom-icons">
                    ...
                    >
                        <img
                            src="../../../public/assets/img/Account.png"
                            alt="User"
                            class="icon"
                        />
                        <span>{{
                            currentLang === "ar" ? "حسابي" : "My Account"
                        }}</span>
                    </router-link>
                </div>
            </div>
        ...
        <nav :class="['navbar', currentLang === 'en' ? 'ltr' : 'rtl']">
            ...
            <div class="navbar__left desktop-icons">
                ...
                <router-link to="/cart" class="icon-link">
                    <img
                        src="../../../public/assets/img/Cart.png"
                        alt="Bag"
                        class="icon"
                    />
                </router-link>
                ...
                <img
                    src="../../../public/assets/img/Ellipse.png"
                    alt="Search"
                    class="icon"
                />
            </div>
...
.icon {
    ...
    height: 34px;
    margin-left: 0;
    filter: brightness(0) saturate(110%) invert(76%) sepia(34%) saturate(409%)
        hue-rotate(337deg) brightness(109%) contrast(97%);
}
